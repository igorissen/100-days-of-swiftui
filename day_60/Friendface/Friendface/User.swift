...
class User: Codable {
    ...
    static let example = User(
        id: UUID(),
        isActive: true,
        name: "Ismaël Gorissen",
        age: 38,
        company: "Keystone Solutions",
        email: "ismael.gorissen@gmail.com",
        address: "Rue Moray 36, 4218 Couthuin, Héron, Belgique",
        about: "Ismael learns SwiftUI with Paul Hudson 100 Days of SwiftUI lessons",
        registered: .now,
        tags: ["swift", "nodejs", "gafieira", "developer"],
        friends: [
            Friend(id: UUID(), name: "Iron Man")
        ]
    )
